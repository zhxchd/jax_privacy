...
for epsilon in [0.0030317898626983737, 0.0042958851847098274, 0.006083590485623323, 0.008611800516297787, 0.012187266063339098, 0.01724384166964077, 0.019758330229927658]:
    filename = f'cifar10_wrn_28_10_eps_{epsilon:.2}.py'
    with open(filename, 'w') as f:
        f.write(template.replace('EPSILON', str(epsilon)))
